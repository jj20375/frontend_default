 ...
 * @param { type Number or String(數字或字串) } operatorId 經營者id
 */
 ...
 *   operator_ids: type Array(陣列) 可使用此分類的經營者id
 *   permission_rule: type String(字串) 數位權限值 1=服務提供者 2=經營者
 * }
 */
 ...
 *   operator_ids: type Array(陣列) 可使用此分類的經營者id (非必要值)
 *   permission_rule: type String(字串) 數位權限值 1=服務提供者 2=經營者 (非必要值)
 * }
 */

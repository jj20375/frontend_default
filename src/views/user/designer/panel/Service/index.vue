    ...
    <div>
        ...
        <el-table :data="datas"
            ...
            <el-table-column min-width="150"
                             label="價位">
                <template v-slot="scope">
                    <div class="font-medium text-red-700">{{ scope.row.store_service.store_service_info !== null ? scope.row.store_service.store_service_info.price : '尚未設定' }}</div>
                </template>
            </el-table-column>

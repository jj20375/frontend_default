...
export default {
    ...
    methods: {
        ...
        /**
         * 取得服務項目單一資料
         * @param { type String or Number(字串或數字) } serviceId 服務項目id
        ...
        openDialog() {
            let self = this;
            self.getCategory("SERVICE", self.$route.params.operatorId);

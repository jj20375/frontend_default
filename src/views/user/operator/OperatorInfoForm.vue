...
/*
 * OperatorUserDataApi = 取得經營者資料
 * UpdateOperatorApi = 更新經營者
 */
...
export default {
    ...
    methods: {
        ...
        /**
         * 取得經營者資料
         * @param { type Number or String(字串或數字) } account 經營者帳號
         */
        ...
        async getGroupLists(groupCode) {
            ...
            if (self.user.group.group_code === "SYSTEM") {
                // 如果為系統使用者時 回傳選擇到的經營者id
                sendGroupOperatorId = self.operatorId;
            } else {
                // 如果為經營者時 回傳登入經營者的經營者id

<template>
    <div>
        ...
        <el-table :data="datas"
                  header-cell-class-name="text-white theadBg whitespace-nowrap"
                  v-loading="loading"
                  border
                  class="w-full mt-2 tableBg">
            ...
            <el-table-column prop="groupName"
                ...
                <template v-slot="scope">
                    ...
                    <div class="font-semibold NotoSansTCFont"
            ...
            <el-table-column min-width="150"
                ...
                <template v-slot="scope">
                    <div class="font-medium text-blue-800">帳號:<span class="ml-2">{{ scope.row.groupable.name }}</span></div>
                    <div class="font-medium text-blue-500">名稱:<span class="ml-2">{{ scope.row.groupable.account }}</span></div>
                </template>
            </el-table-column>
            <el-table-column prop="isSub"
                             ...
                             label="子帳專用">
                <template v-slot="scope">
                    <div class="text-center rounded-xl inline-block px-3 py-3 w-20 y-20 text-white"
                         :class="scope.row.is_sub === 1 ? 'bg-red-800' : 'bg-green-500'">
            ...
            <el-table-column label="操作"
                ...
                <template v-slot="scope">
                    <button type="button"
                            class="blue-btn-outline px-2 py-2 text-xl"
    ...
    methods: {
        ...
        roleColor(val) {
            let roles = {
                ...
                DESIGNER: "text-red-500",
                ASSISTANT: "text-yellow-500",
